...
st.title("project1")
st.header("Diamond")
image = Image.open('/Users/lubna/Desktop/Screenshot 2024-04-23 at 6.03.18.png')
...
st.pyplot()
st.write("The relationship between Cut and over Price")
...
st.set_option('deprecation.showPyplotGlobalUse', False)
st.pyplot()
st.write("The relationship between Color and over Price ")
...
st.set_option('deprecation.showPyplotGlobalUse', False)
st.pyplot()
st.write("The relationship Report and over Price ")
...
st.pyplot()
st.write("The relationship Clarity and over Price ")
...
st.pyplot()
st.write("The relationship over weight and over Price ")
...
st.pyplot()
st.write("The relationship Polish and over Price ")
...
st.set_option('deprecation.showPyplotGlobalUse', False)
st.write("The relationship Symmetry and over Price ")
